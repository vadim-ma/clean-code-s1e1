...
const incompletedTasksHolder = document.getElementById("incompleted-tasks");//ul of #incompleteTasks
...
const bindTaskEvents = function (taskListItem, checkBoxEventHandler) {
  ...
  const checkBox = taskListItem.querySelector(".task-list__completed");
